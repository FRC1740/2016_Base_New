...
autoGroupBaseline::autoGroupBaseline()
{
	...
	// AddSequential(new Move(0, .5, 3.0)); // move at 0 degrees (forward) at half speed for 3 seconds

	// Guesstimating that we need half the time since 8" mecanum wheels travel twice as far in one rev.
	AddSequential(new autoMove(0, .5, 1.5)); // move at 0 degrees (forward) at half speed for 3 seconds
}
